...
// GetCommitLogs retrieves commit history and file changes starting from fromHash
func GetCommitLogs(repoPath string, fromHash string) ([]Commit, []Change, error) {
...
func getCommitChanges(commit *object.Commit, commitIndex int) ([]Change, error) {
	var changes []Change
